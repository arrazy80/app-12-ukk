    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between">
                <div class="theme-toggle d-flex gap-2 mt-2">
                    <span href="" class="app-brand-text demo menu-text fw-bolder" style="font-size: 20px">SEEBOOK</span>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  ">
                    <a href="{{ route('peminjaman.data.admin') }}" class='sidebar-link'>
                        <i class="bi bi-stack"></i>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  ">
                    <a href="{{ route('peminjaman.data.petugas') }}" class='sidebar-link'>
                        <i class="bi bi-stack"></i>
                        <span>Peminjaman </span>
                    </a>
                </li>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  ">
                    <a href="{{ route('peminjaman.data') }}" class='sidebar-link'>
                        <i class="bi bi-stack"></i>
                        <span>Peminjaman </span>
                    </a>
                </li>
